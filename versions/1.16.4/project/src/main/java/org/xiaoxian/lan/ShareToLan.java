...
public class ShareToLan {
    ...
    private static void startHttpApi(IntegratedServer server) {
    ...
    private static void updateApiInfo(IntegratedServer server) {
        updateService.scheduleAtFixedRate(() -> {
            ...
            HTTP_API_SERVER.set("difficulty", String.valueOf(server.func_241755_D_().getDifficulty()));
    ...
    private static void sendLanInfo(IntegratedServer server) {
        executorService.submit(() -> {
    ...
    private static void setMaxPlayer(IntegratedServer server) {
