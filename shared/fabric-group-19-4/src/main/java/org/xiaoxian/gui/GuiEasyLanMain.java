...
public class GuiEasyLanMain extends Screen {
    ...
    public GuiEasyLanMain(Screen parentScreen) {
        super(createTranslatableComponent("easylan.setting"));
    ...
    private static Component createTranslatableComponent(String key) {
        try {
        ...
        try {
            ...
            Object value = constructor.newInstance(key);
            if (value instanceof Component component) {
                return component;
            }
        } catch (ReflectiveOperationException ignored) {
